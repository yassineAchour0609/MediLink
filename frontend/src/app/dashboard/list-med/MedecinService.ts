...
export class MedecinService {
  ...
  getRendezVous(idMedecin: number): Observable<{ success: boolean; rendezvous: any[]; stats?: any }> {
    return this.http.get<{ success: boolean; rendezvous: any[]; stats?: any }>(`${apiUrl}/${idMedecin}/dashboard/rendezvous`);
  }
}
