...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 09 nov. 2025 à 12:23
...
(1, 1, 'test', '2025-11-20', 'test', 'test', 18, 'test', NULL, '2025-11-07 20:51:54');
...
(1, 16, '2025-11-07 19:00:30', 'test', 'test', 'test', 'test', '2025-11-07 20:54:46', 'test');
...
(1, 1, '2025-11-07', 18, 'test', 'test', 'test', 'test', NULL, '2025-11-07 20:52:18');
...
--
ALTER TABLE `dossiermedical`
  MODIFY `idDossier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
